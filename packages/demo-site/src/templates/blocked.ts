...
<body>
    <div class="container">
        ...
        <section class="failed-checks">
            <h3>Failed Detection Checks</h3>
            <div id="failed-checks-list" class="failed-checks-list">
        ...
        <section class="explanation">
            ...
            <p>
                This page uses multiple bot detection techniques to identify automated browsers.
                Your browser failed one or more critical checks, indicating it's likely running
                in automated/headless mode.
            </p>
        </section>
...
// Now you'll get the secret content!</code></pre>
        </section>

        <section class="links">
            <a href="/" class="button">← Back to Documentation</a>
            <a href="https://github.com/zorillajs/zorilla" class="button button-secondary">View on GitHub</a>
        </section>

        <footer>
            <p class="note">Detection Score: <span id="detection-score">--</span> / 124 (Threshold: 75)</p>
        </footer>
    </div>
