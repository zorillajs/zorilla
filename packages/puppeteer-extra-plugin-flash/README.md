...
```bash
npm install @zorilla/puppeteer-extra-plugin-flash
```
...
### [Plugin](https://github.com/zorillajs/zorilla/blob/db57ea66cf10d407cf63af387892492e495a84f2/packages/puppeteer-extra-plugin-flash/index.js#L31-L100)
